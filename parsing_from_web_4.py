...
Please run your program to find the place_id for "Banaras Hindu University" and enter the place_id and your Python code below. Hint: The first seven characters of the place_id are "ChIJqSi ..."
...
```
## -- End pasted text --
Enter a place name: Banaras Hindu University
Retrieving http://python-data.dr-chuck.net/geojson?sensor=false&address=Banaras+
Hindu+University
Retrieved 2067 characters
Place id ChIJqSiSwCkyjjkRu9CM8rpJVP0
```
